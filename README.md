...
- 🖥️ **low-level graphics** — KMS color pipelines, HDR, Wayland compositors on wlroots.
...
|---|---|---|
| [**wlgame**](https://github.com/Sigmachan/wlgame) | gaming Wayland compositor — XWayland, VRR, HDR, FSR/NIS/CAS | `C` · wlroots |
| [**perfmax**](https://github.com/Sigmachan/perfmax) | AI-driven real-time OS performance optimizer | `Rust` · egui |
